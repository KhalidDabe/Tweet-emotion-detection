...
# alpha here is Additive (Laplace/Lidstone) smoothing parameter the default value is 1.0 but it was tuned to achieve more accuracy
mul = MultinomialNB(alpha=16.0)

classifier = mul.fit(X_train, y_train)

y_pred = mul.predict(X_test)

# find the accuracy
print('\n'"Accuracy of our Naive Bayes Classifier is: ",
      metrics.accuracy_score(y_test, y_pred) * 100, "\n")

print(metrics.classification_report(y_test, y_pred), "\n")

# cross validation for naive bayes
cvRF = cross_val_score(mul, X, y)

print("5 - cross validation results for Naive Bayes : \n\n")
